...
RiftSketch is a HTML5 live-coding environment for the Oculus Rift.
...
If you happen to have a Rift and you want to try it out yourself, download the Windows or OS X dev build of Firefox that includes the WebVR APIs from http://blog.bitops.com/blog/2014/08/20/updated-firefox-vr-builds/ and visit http://brianpeiris.github.io/RiftSketch with your Rift hooked up.
